...
class NotificationHandler(val context: Context) {
     ...
     * just put it on the notification central without pop-up or sound.
     **/
     ...
     * instead of just getting the notification put inside the notification central.
    ...
    fun sendNotification(
        ...
        val builder = NotificationCompat.Builder(context, channelId)
            .setSmallIcon(R.drawable.fcm_tester_notification_icon).setContentTitle(title)
            .setContentText(body)
